...
export default function SCGEPDashboard({
  ...
  const loadScenarioData = async (scenario: string) => {
    ...
    try {
      ...
      const solutionResponse = await fetch('/api/sc-gep', {
        method: 'POST',
      ...
      const bottleneckResponse = await fetch('/api/sc-gep/bottlenecks', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          scenario,
      ...
      // Load scenario comparison if enabled
      if (enableComparison) {
        const comparisonResponse = await fetch('/api/sc-gep/comparison', {
          method: 'POST',
          headers: { 'Content-Type': 'application/json' },
          body: JSON.stringify({
