    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="bg-gradient-to-r from-amber-50 to-yellow-50 border-b border-amber-200">
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-6 rounded-xl border border-amber-200 text-center">
              <div className="text-3xl font-light text-gray-900 mb-2">
                {operationalMines.length}
              </div>
              <div className="text-sm font-medium text-gray-700 mb-1">Active Mines</div>
            ...
            <div className="bg-white p-6 rounded-xl border border-amber-200 text-center">
              ...
              <div className="text-sm font-medium text-gray-700 mb-1">oz Gold/Year</div>
            ...
            <div className="bg-white p-6 rounded-xl border border-amber-200 text-center">
              ...
              <div className="text-sm font-medium text-gray-700 mb-1">Tailings Value</div>
            ...
            <div className="bg-white p-6 rounded-xl border border-amber-200 text-center">
              ...
              <div className="text-sm font-medium text-gray-700 mb-1">Jobs</div>
              <div className="text-xs text-gray-600">
                Direct employment
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <h4 className="font-medium text-gray-900 text-sm">{mine.name}</h4>
                      <p className="text-xs text-gray-600 mt-1">{mine.operator}</p>
                      <div className="flex items-center mt-2">
                        <MapPin className="h-3 w-3 text-gray-400 mr-1" />
                        <span className="text-xs text-gray-500">{mine.location.region}</span>
                      </div>
                    </div>
            ...
            {selectedMine && (
              <div>
                <div className="flex items-center justify-between mb-6">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">{selectedMine.name}</h3>
                    <p className="text-sm text-gray-600">{selectedMine.operator}</p>
                  </div>
                  <div className="text-right">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-4">Production</h4>
                    <div className="space-y-3">
                      <div className="flex justify-between py-2 border-b border-gray-100">
                        <span className="text-sm text-gray-600">Annual Output</span>
                      ...
                      <div className="flex justify-between py-2">
                        <span className="text-sm text-gray-600">Life of Mine</span>
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-4">Economics</h4>
                    <div className="space-y-3">
                      <div className="flex justify-between py-2 border-b border-gray-100">
                        <span className="text-sm text-gray-600">All-in Cost</span>
        ...
        <Card className="p-6">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-lg font-medium text-gray-900">Tailings Reprocessing Opportunity</h3>
              <p className="text-sm text-gray-600">Recover gold from existing waste - immediate value creation</p>
            </div>
            <div className="text-right">
              <div className="text-2xl font-light text-green-600">
                ${(totalTailingsValue / 1000000000).toFixed(1)}B
              </div>
              <div className="text-sm text-gray-600">Net recoverable value</div>
            </div>
          </div>
              ...
              return (
                <div key={index} className="bg-gradient-to-br from-amber-50 to-yellow-50 p-6 rounded-lg border border-amber-200">
                  <div className="flex items-center justify-between mb-4">
                    <h4 className="font-medium text-gray-900">{tailings.location}</h4>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-sm">
                      <div>
                        <div className="text-gray-600">Gold Content</div>
        ...
        <Card className="p-6 bg-gradient-to-r from-emerald-50 to-indigo-50 border-emerald-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="bg-white p-4 rounded-lg">
              <div className="text-lg font-medium text-gray-900 mb-2">Immediate Action</div>
            ...
            <div className="bg-white p-4 rounded-lg">
              <div className="text-lg font-medium text-gray-900 mb-2">Technology Focus</div>
              <p className="text-sm text-gray-700 mb-3">
            ...
            <div className="bg-white p-4 rounded-lg">
              <div className="text-lg font-medium text-gray-900 mb-2">Market Position</div>
              <p className="text-sm text-gray-700 mb-3">
