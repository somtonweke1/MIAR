      ...
      <div className="max-w-7xl mx-auto px-6 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Card className="p-6 text-center">
            ...
            <div className="text-sm font-medium text-gray-700 mb-1">Major Operations</div>
          ...
          <Card className="p-6 text-center">
            ...
            <div className="text-sm font-medium text-gray-700 mb-1">Direct Jobs</div>
          ...
          <Card className="p-6 text-center">
            ...
            <div className="text-sm font-medium text-gray-700 mb-1">Network Links</div>
        ...
        {viewMode === 'overview' && (
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            {/* Regional Selection */}
            <Card className="p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Select Region/Operation</h3>

              <div className="space-y-2 mb-6">
                <button
                  onClick={() => setSelectedRegion('all')}
                  className={`w-full p-3 text-left rounded-lg border transition-all ${
                    selectedRegion === 'all' ? 'border-blue-500 bg-blue-50' : 'border-gray-200 hover:border-gray-300'
                  }`}
                >
                  <div className="font-medium text-gray-900">All Africa</div>
                  <div className="text-sm text-gray-600">{AFRICAN_MINING_OPERATIONS.length} operations</div>
                </button>
                    ...
                    >
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <div className="text-sm text-gray-600">{regionOps.length} operations</div>
                        </div>
              ...
              <div className="space-y-2 max-h-64 overflow-y-auto">
                {filteredOperations.map((operation) => (
                  ...
                  >
                    ...
                    <div className="text-xs text-gray-600">{operation.country} • {operation.production.primary_commodity}</div>
              ...
              {selectedOperation && (
                <div>
                  <div className="flex items-start justify-between mb-6">
                    <div>
                      <h3 className="text-xl font-medium text-gray-900">{selectedOperation.name}</h3>
                      <p className="text-gray-600">{selectedOperation.operator} • {selectedOperation.country}</p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="font-medium text-gray-900 mb-4">Production & Resources</h4>
                      <div className="space-y-3">
                        <div className="flex justify-between py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Primary Commodity</span>
                        ...
                        <div className="flex justify-between py-2">
                          ...
                          <div className="text-right">
                            {selectedOperation.commodities.map((commodity, idx) => (
                              <span key={idx} className="inline-block ml-1 px-2 py-0.5 text-xs bg-gray-100 rounded">
                                {commodity}
                              </span>
                            ))}
                          </div>
                    ...
                    <div>
                      <h4 className="font-medium text-gray-900 mb-4">Economic Impact</h4>
                      <div className="space-y-3">
                        <div className="flex justify-between py-2 border-b border-gray-100">
                        ...
                        <div className="flex justify-between py-2 border-b border-gray-100">
                          <span className="text-sm text-gray-600">Govt Revenue</span>
                        ...
                        <div className="flex justify-between py-2">
                          <span className="text-sm text-gray-600">Export Markets</span>
                          <div className="text-right">
        ...
        {viewMode === 'connections' && (
          <div className="space-y-6">
            <Card className="p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Cross-Border Mining Network Connections</h3>
                    ...
                    <div key={idx} className={`p-4 border rounded-lg ${getConnectionStrengthColor(connection.strength)}`}>
                      <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-xs text-gray-600">Strength: {(connection.strength * 100).toFixed(0)}%</div>
                        </div>
                      </div>
          ...
          <div className="space-y-6">
            <Card className="p-6">
              <div className="flex items-center justify-between mb-6">
                <div>
                  <h3 className="text-lg font-medium text-gray-900">Global Trade Routes from Africa</h3>
                  <p className="text-sm text-gray-600">Major mineral export corridors connecting Africa to global markets</p>
                </div>
                <div className="text-right">
                  <div className="text-2xl font-light text-gray-900">95M</div>
                  <div className="text-sm text-gray-600">tonnes/year to China alone</div>
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {GLOBAL_TRADE_ROUTES.map((route, idx) => (
                  <div key={idx} className={`p-6 rounded-lg border-2 ${
                    route.strategic_importance === 'critical' ? 'border-red-200 bg-red-50' : 'border-blue-200 bg-blue-50'
                  }`}>
                    <div className="flex items-center justify-between mb-4">
                      <h4 className="font-medium text-gray-900">{route.commodity}</h4>
                      <span className={`px-2 py-1 text-xs rounded-full ${
                        route.strategic_importance === 'critical' ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'
                      }`}>
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="text-sm">
                        <span className="text-gray-600">Key Infrastructure:</span>
            ...
            {/* Global Market Share */}
            <Card className="p-6">
              <h3 className="text-lg font-medium text-gray-900 mb-4">Africa's Global Market Control</h3>
              <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
                {Object.entries(continentalImpact.global_market_share).map(([commodity, share]) => (
                  <div key={commodity} className="text-center">
                    <div className="text-3xl font-light text-gray-900 mb-2">{share}%</div>
                    <div className="text-sm font-medium text-gray-700 capitalize">{commodity}</div>
                    <div className="text-xs text-gray-500">Global market share</div>
                  </div>
                ))}
              </div>
            </Card>
            ...
            {vulnerabilities.map((vuln, idx) => (
              <Card key={idx} className="p-6 border-l-4 border-l-red-500">
                <div className="flex items-start justify-between mb-4">
                  <div>
                    ...
                    <span className={`inline-block mt-2 px-2 py-1 text-xs rounded-full ${
                      vuln.risk_level === 'high' ? 'bg-red-100 text-red-800' :
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                  <div>
                    <h4 className="font-medium text-gray-900 mb-3">Global Impact</h4>
                    <p className="text-sm text-gray-700 mb-4">{vuln.global_impact}</p>

                    <h4 className="font-medium text-gray-900 mb-3">Affected Operations</h4>
