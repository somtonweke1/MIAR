          ...
          <div className="flex items-center gap-4">
            ...
            {metrics.constraintsMonitored > 0 && (
              <div className="flex items-center gap-2 px-3 py-1.5 bg-violet-50 border border-violet-200 rounded-lg">
                ...
                <div>
                  <div className="text-xs text-violet-600 font-medium">Active Constraints</div>
                  <div className="text-lg font-bold text-violet-700">{metrics.constraintsMonitored}</div>
                </div>
              </div>
            )}
          </div>
